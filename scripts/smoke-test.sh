...
body_has_error_marker() {
  # __next_error__ = Next's error-page <html id>; the client-exception text
  # appears when the server streams the error shell.
  grep -q '__next_error__\|Application error: a client-side exception' "$1"
}
